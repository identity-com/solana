...
export function AccountHeader({
  ...
  const isGatewayProgram = parsedData?.program === "gateway";
...
function InfoSection({ account }: { account: Account }) {
  ...
  } else if (parsedData && parsedData.program === "gateway") {
    return (
      <GatewayTokenAccountSection
        account={account}
        tokenAccount={parsedData.parsed}
      />
    );
  } else if (parsedData && parsedData.program === "didsol") {
    return <DidSolAccountSection account={account} soldata={parsedData.parsed} />;
